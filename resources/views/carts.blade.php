        ...
        <div class="row" id="cart_items_details">
            <div class="col-lg-9">
                ...
                <div class="in-cart-box">
                    <div class="title">{{ Cart::getContent()->count() }} courses in cart</div>
                    <div class="">
                                ...
                                <div class="cart-course-wrapper">
                                    <div class="image">
                                        <a href="{{ route('course_detail', $cart->id) }}">
                                            <img src="{{ asset('images/'. $cart->attributes['image_url'])}}" alt="" class=" img-fluid">
                                        </a>
                                    </div>
                                    <div class="details">
                                        <a href="{{ route('course_detail', $cart->id) }}">
            ...
            <div class="col-lg-3">
                <div class="cart-sidebar">
                    ...
                    <button type="button" class="btn btn-primary btn-block checkout-btn" onclick="handleCheckOut()">Checkout
                    </button>
                </div>
            </div>
        </div>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (!res.success) {
                    ...
                    location.href = '{{route("carts.checkout")}}';
                }
            }
        });
    }
