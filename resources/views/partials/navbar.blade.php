        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <form class="inline-form" action="{{ route('course_search') }}" method="GET" style="width: 100%;">
                    ...
                    <div class="sign-in-box btn-group">
                        ...
                        <button type="button" class="btn btn-sign-in" data-toggle="modal" data-target="#signInModal">Login
                        </button>

                        <button type="button" class="btn btn-sign-up" data-toggle="modal" data-target="#signUpModal">Sign up
                        </button>
