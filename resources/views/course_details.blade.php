                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="review-details">
                                            <div class="rating">
                                                @for($i = 1; $i < 6; $i++) @if ($i <=$review->rating)
                                                    <i class="fas fa-star filled" style="color: #f5c85b;"></i>
                                                    @else
                                                    <i class="fas fa-star" style="color: #abb0bb;"></i>
                                                    @endif
                    ...
                    <div class="course-sidebar-text-box">
                        ...
                        <div class="buy-btns">
                            ...
                            <a href="" class="btn btn-buy-now" id="course_2" onclick="handleBuyNow(this)">Buy
                                now</a>
                            <button class="btn btn-add-cart addedToCart" type="button" id="{{ $course->id }}" onclick="handleCartItems(this)">Added to cart
                            </button>
                            @else
                            <form action="{{ route('cart.add') }}" method="post">
                                ...
                                <input type="hidden" value="{{ $course->image_url }}" name="image_url">
